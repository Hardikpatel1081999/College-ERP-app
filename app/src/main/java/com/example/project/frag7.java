                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            for (DataSnapshot ds: snapshot.getChildren()){
                                ...
                                if(nn.contentEquals(n)){
                                    ...
                                    {
                                        try {
                                            DatabaseReference dx = databaseReference.child("Time").child(j).child("Sunday");
                                        ...
                                        }catch (Exception e)
                                        {
                                            ...
                                            Toast.makeText(getContext(),"Sunday TimeTable is Not Present ",Toast.LENGTH_SHORT).show();
                                        }
