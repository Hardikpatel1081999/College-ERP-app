                            ...
                            for (DataSnapshot ds: snapshot.getChildren()){
                                ...
                                if(nn.contentEquals(n)){
                                    if(ss.contentEquals(s))
                                    {
                                            ...
                                            DatabaseReference dx = databaseReference.child("Time").child(j).child("Tuesday");
                                            dx.addValueEventListener(new ValueEventListener() {
                                                ...
                                                {
                                                    Toast.makeText(getContext(),"Tuesday TimeTable is Not Alloted ",Toast.LENGTH_SHORT).show();
                                                }
