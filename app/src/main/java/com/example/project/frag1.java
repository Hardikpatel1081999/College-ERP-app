                       ...
                       public void onDataChange(@NonNull DataSnapshot snapshot) {
                           for (DataSnapshot ds: snapshot.getChildren()){
                               ...
                               if(nn.contentEquals(n)){
                                   ...
                                   {
                                       try {
                                           DatabaseReference dx = databaseReference.child("Time").child(j).child("Monday");
                                           dx.addValueEventListener(new ValueEventListener() {
                                               ...
                                               public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                   ...
                                                   {
                                                       Toast.makeText(getContext(),"Tuesday TimeTable is Not Alloted yet ",Toast.LENGTH_SHORT).show();
                                                   }
                                       ...
                                       }catch (Exception e)
                                       {
                                           ...
                                           Toast.makeText(getContext(),"Monday TimeTable is Not Present ",Toast.LENGTH_SHORT).show();
                                       }
