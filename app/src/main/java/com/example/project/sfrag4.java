...
public class sfrag4 extends Fragment {
    @Nullable
    @Override
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            for (DataSnapshot ds: snapshot.getChildren()){
                                ...
                                if(ss.contentEquals(s)){
                                    ...
                                    {
                                        if(xy.equals(x)){
                                            DatabaseReference dx = databaseReference.child("Time").child(j).child("Thrusday");
                                            dx.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    {
                                                        Toast.makeText(getContext(),"Thrusday Timetable is Not  Alloted",Toast.LENGTH_SHORT);
                                                    }
                                                }
